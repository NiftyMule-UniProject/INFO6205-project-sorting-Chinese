package edu.neu.coe.info6205.compSort.huskySort.huskySort;

import edu.neu.coe.info6205.compSort.huskySort.Helper;
import edu.neu.coe.info6205.compSort.huskySort.InstrumentedHelper;
import edu.neu.coe.info6205.compSort.huskySort.SortWithHelper;
import edu.neu.coe.info6205.compSort.huskySort.huskySortUtils.HuskyCoderFactory;
import edu.neu.coe.info6205.compSort.huskySort.huskySortUtils.HuskyHelper;
import edu.neu.coe.info6205.compSort.huskySort.huskySortUtils.HuskySortable;
import edu.neu.coe.info6205.compSort.huskySort.sort.AbstractHuskySort;
import edu.neu.coe.info6205.compSort.huskySort.sort.HuskySortBenchmarkHelper;
import edu.neu.coe.info6205.compSort.huskySort.sort.IntroHuskySort;
import edu.neu.coe.info6205.compSort.huskySort.sort.QuickHuskySort;
import edu.neu.coe.info6205.compSort.huskySort.utils.Config;
import edu.neu.coe.info6205.compSort.huskySort.utils.ConfigTest;
import edu.neu.coe.info6205.compSort.huskySort.utils.PrivateMethodInvoker;
import edu.neu.coe.info6205.compSort.huskySort.utils.StatPack;
...
import static edu.neu.coe.info6205.compSort.huskySort.huskySortUtils.HuskySortHelper.generateRandomAlphaBetaArray;
...
public class HuskySortTest
{
    ...
    public void testSortPerson()
    {
        ...
        assertTrue(sorter.getHelper().sorted(sorted), "sorted");
    }
    ...
    public void testSortString1()
    {
        ...
        assertTrue(sorter.getHelper().sorted(sorter.sort(xs)), "sorted");
    }
    ...
    public void testSortString2()
    {
        ...
        assertTrue(helper.sorted(ys), "sorted");
    ...
    public void testSortOldDate()
    {
        ...
        AbstractHuskySort<Date> sorter = new QuickHuskySort<>(HuskyCoderFactory.dateCoder, config);
        assertTrue(sorter.getHelper().sorted(sorter.sort(xs)), "sorted");
    }
    ...
    public void testSortJavaTime()
    {
        ...
        QuickHuskySort<ChronoLocalDateTime<?>> sorter = new QuickHuskySort<>(HuskyCoderFactory.chronoLocalDateTimeCoder, config);
        assertTrue(sorter.getHelper().sorted(sorter.sort(xs)), "sorted");
    }
