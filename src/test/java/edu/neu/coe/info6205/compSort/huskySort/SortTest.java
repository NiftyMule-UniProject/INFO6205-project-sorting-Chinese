package edu.neu.coe.info6205.compSort.huskySort;

import edu.neu.coe.info6205.compSort.huskySort.simple.MergeSortBasicTest;
...
public class SortTest
{
    ...
    public void testSort3() throws IOException
    {
        ...
        final Integer[] xs = helper.random(Integer.class, r -> r.nextInt(1000000));
        sorter.sort(xs, 0, xs.length);
        assertFalse(helper.sorted(xs), "array should not be sorted - except under extremely rare circumstances");
    }
