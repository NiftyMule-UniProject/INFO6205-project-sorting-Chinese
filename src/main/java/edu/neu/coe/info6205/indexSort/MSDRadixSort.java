...
public class MSDRadixSort implements SortInterface
{
    ...
    public MSDRadixSort(int cutoff)
    {
        this.helper = new UnicodeSortingHelper();
        this.cutoff = cutoff;
    }

    public MSDRadixSort(UnicodeSortingHelper helper)
    {
        this.helper = helper;
        cutoff = 16;
    }

    public MSDRadixSort(UnicodeSortingHelper helper, int cutoff)
    {
        this.helper = helper;
        this.cutoff = cutoff;
    }
